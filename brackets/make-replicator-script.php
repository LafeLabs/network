...
<?php
    ...
    $baseurl = "https://raw.githubusercontent.com/LafeLabs/network/main/brackets/";
    
    $setname = "brackets";//put your set name here
    $copyscript = "mkdir ".$setname."\n";
    $copyscript .= "cd ".$setname."\n";
    $copyscript .= "wget https://raw.githubusercontent.com/LafeLabs/network/main/brackets/replicator.php\n";
