...
def log_values():
    output_value ={}
    output_value["x_acceleration"]="{:>6.2f}".format(acceleration[0])
    output_value["y_acceleration"]="{:>6.2f}".format(acceleration[1])
    output_value["z_acceleration"]="{:>6.2f}".format(acceleration[2])
    print(json.dump(output_value))
