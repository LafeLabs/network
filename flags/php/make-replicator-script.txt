...
<?php
    ...
    $baseurl = "https://raw.githubusercontent.com/LafeLabs/network/main/flags/";
    
    $setname = "mynewset";//put your set name here
    $copyscript = "mkdir ".$setname."\n";
    $copyscript .= "cd ".$setname."\n";
    $copyscript .= "wget https://raw.githubusercontent.com/LafeLabs/network/main/flags/replicator.php\n";
